...
function checkURL()
{
    ...
    if (request.getParameter("menu") == null) { 
    	...
    	header=request.getParameter("menu");  }
...
<h2 align="center" style="text-align: center;"><%= header %></h2></div>

<br/>
<br/>
<form action="storeData" method="post" onsubmit="return ValidateForm();" > 
<input type="hidden" id="menu" value="<%=header%>" name="menu"/>
<table>
<tr>
<td>
<label >Heading </label>
...
&nbsp;
&nbsp;
<textarea type="" id="body" style="height: 100px;width: 500px" name="body"></textarea>
